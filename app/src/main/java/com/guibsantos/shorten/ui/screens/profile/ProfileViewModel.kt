...
import com.guibsantos.shorten.data.repository.AuthRepository
import com.guibsantos.shorten.ui.utils.ErrorUtils
...
class ProfileViewModel @Inject constructor(
    ...
    fun fetchUserProfile() {
        if (_username.value != "Carregando...") return
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    _avatarUrl.value = if (user.avatarUrl != null)
